            ...
            <div className="flex flex-row justify-center w-full h-screen pt-10">
                ...
                <div className="flex flex-col pl-6">
                    ...
                    <div className="w-full p-8 pb-12 border-2 bg-gray-50 pr-50 rounded-2xl">
                        ...
                        <a href="#_" className="relative px-40 py-5 overflow-hidden text-white transition-all duration-300 ease-out bg-orange-500 rounded-2xl group hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-400 hover:ring-2 hover:ring-offset-2 hover:ring-orange-400">
