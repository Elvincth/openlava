...
const Home: NextPage = () => {
  return (
    <div className="flex w-full h-screen flex-col overflow-y-auto">
      <Header />
      <section className="flex flex-col px-40 w-full max-h-[580px] bg-cover bg-[url('https://res.cloudinary.com/dasq4goqg/image/upload/v1645114580/Rectangle_461_amalkp.png')]" >
      ...
      {/* map the data2 */}
      <section className="grid grid-cols-3 self-center gap-20 pb-20">
        {data2.map((item) => (
          <Card
            key={item.imageSrc}
            imageSrc={item.imageSrc}
